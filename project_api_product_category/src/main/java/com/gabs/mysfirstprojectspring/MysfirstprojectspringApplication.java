package com.gabs.mysfirstprojectspring;
...
public class MysfirstprojectspringApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(MysfirstprojectspringApplication.class, args);
	}
